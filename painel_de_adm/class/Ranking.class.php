...
class Ranking {
    ...
    function TotalPaginas(){
        try{
            $rank =  pg_query("SELECT * FROM accounts WHERE rank<'53' AND player_name<>'' AND rank>'5'");
	...
	function TotalPaginasIP(){
        try{
            $rank =  pg_query("SELECT * FROM accounts WHERE lastip<>'0' AND banexpires='0'");
            $total = pg_num_rows($rank);
            $tp = $total / 20;
            return $tp;
        }catch(PDOException $e){
	...
	function RankingGeralIP($inicio){
        try{
            $rank1 = pg_query("SELECT * FROM accounts WHERE lastip<>'0' AND banexpires='0' ORDER BY lastip DESC LIMIT 20 OFFSET '$inicio'");
            $ranking1 = pg_fetch_all($rank1);
            return $ranking1;
        }catch(PDOException $e){
            echo "Erro: ".$e->getMessage();
	...
	function tickets($inicio){
        try{
            $rank1 = pg_query("SELECT * FROM suporte ORDER BY status ASC LIMIT 12 OFFSET '$inicio'");
            $ranking1 = pg_fetch_all($rank1);
            return $ranking1;
        }catch(PDOException $e){
            echo "Erro: ".$e->getMessage();
	...
	function totaltickets($inicio){
        try{
            $rank =  pg_query("SELECT * FROM suporte");
            $total = pg_num_rows($rank);
            $tp = $total / 12;
            return $tp;
        }catch(PDOException $e){
	...
	function newtickets($inicio){
        try{
            $rank1 = pg_query("SELECT * FROM suporte WHERE status='0' ORDER BY id ASC LIMIT 12 OFFSET '$inicio'");
            $ranking1 = pg_fetch_all($rank1);
            return $ranking1;
        }catch(PDOException $e){
            echo "Erro: ".$e->getMessage();
	...
	function Totalnewtickets($inicio){
        try{
            $rank =  pg_query("SELECT * FROM suporteWHERE status='0'");
            $total = pg_num_rows($rank);
            $tp = $total / 12;
            return $tp;
        }catch(PDOException $e){
	...
	function resptickets($inicio){
        try{
            $rank1 = pg_query("SELECT * FROM suporte WHERE status='1' ORDER BY id ASC LIMIT 12 OFFSET '$inicio'");
            $ranking1 = pg_fetch_all($rank1);
            return $ranking1;
        }catch(PDOException $e){
            echo "Erro: ".$e->getMessage();
	...
	function Totalresptickets($inicio){
        try{
            $rank =  pg_query("SELECT * FROM suporteWHERE status='1'");
            $total = pg_num_rows($rank);
            $tp = $total / 12;
            return $tp;
        }catch(PDOException $e){
