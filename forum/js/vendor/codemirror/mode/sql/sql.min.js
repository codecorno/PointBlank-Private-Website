...
if(47<d.charCodeAt(0)&&58>d.charCodeAt(0))return c.match(/^[0-9]*(\.[0-9]+)?([eE][-+]?[0-9]+)?/),h.decimallessFloat&&c.match(/^\.(?!\.)/),"number";if("?"==d&&(c.eatSpace()||c.eol()||c.eat(";")))return"variable-3";if("'"==d||'"'==d&&h.doubleQuote)return b.tokenize=a(d),b.tokenize(c,b);if(!(h.nCharCast&&("n"==d||"N"==d)||h.charsetCast&&"_"==d&&c.match(/[a-z][a-z0-9]*/i))||"'"!=c.peek()&&'"'!=c.peek()){if(h.commentSlashSlash&&"/"==d&&c.eat("/")||h.commentHash&&"#"==d||"-"==d&&c.eat("-")&&(!h.commentSpaceRequired||
c.eat(" ")))return c.skipToEnd(),"comment";if("/"==d&&c.eat("*"))return b.tokenize=f(1),b.tokenize(c,b);if("."==d){if(h.zerolessFloat&&c.match(/^(?:\d+(?:e[+-]?\d+)?)/i))return"number";if(c.match(/^\.+/))return null;if(h.ODBCdotTable&&c.match(/^[\w\d_]+/))return"variable-2"}else{if(n.test(d))return c.eatWhile(n),"operator";if(p.test(d))return c.eatWhile(p),"bracket";if(q.test(d))return c.eatWhile(q),"punctuation";if("{"==d&&(c.match(/^( )*(d|D|t|T|ts|TS)( )*'[^']*'( )*}/)||c.match(/^( )*(d|D|t|T|ts|TS)( )*"[^"]*"( )*}/)))return"number";
c.eatWhile(/^[_\w\d]/);b=c.current().toLowerCase();return t.hasOwnProperty(b)&&(c.match(/^( )+'[^']*'/)||c.match(/^( )+"[^"]*"/))?"number":u.hasOwnProperty(b)?"atom":v.hasOwnProperty(b)?"builtin":w.hasOwnProperty(b)?"keyword":x.hasOwnProperty(b)?"string-2":null}}else return"keyword"}function a(a){return function(c,d){for(var b=!1,f;null!=(f=c.next());){if(f==a&&!b){d.tokenize=k;break}b=y&&!b&&"\\"==f}return"string"}}function f(a){return function(c,d){var b=c.match(/^.*?(\/\*|\*\/)/);b?d.tokenize=
"/*"==b[1]?f(a+1):1<a?f(a-1):k:c.skipToEnd();return"comment"}}function r(a,b,f){b.context={prev:b.context,indent:a.indentation(),col:a.column(),type:f}}var x=g.client||{},u=g.atoms||{"false":!0,"true":!0,"null":!0},v=g.builtin||{},w=g.keywords||{},n=g.operatorChars||/^[*+\-%<>!=&|~^]/,h=g.support||{},m=g.hooks||{},t=g.dateSQL||{date:!0,time:!0,timestamp:!0},y=!1!==g.backslashStringEscapes,p=g.brackets||/^[\{}\(\)\[\]]/,q=g.punctuation||/^[;.,:]/;return{startState:function(){return{tokenize:k,context:null}},
token:function(a,b){a.sol()&&b.context&&null==b.context.align&&(b.context.align=!1);if(b.tokenize==k&&a.eatSpace())return null;var c=b.tokenize(a,b);if("comment"==c)return c;b.context&&null==b.context.align&&(b.context.align=!0);var f=a.current();"("==f?r(a,b,")"):"["==f?r(a,b,"]"):b.context&&b.context.type==f&&(b.indent=b.context.indent,b.context=b.context.prev);return c},indent:function(a,b){a=a.context;if(!a)return e.Pass;b=b.charAt(0)==a.type;return a.align?a.col+(b?0:1):a.indent+(b?0:l.indentUnit)},
blockCommentStart:"/*",blockCommentEnd:"*/",lineComment:h.commentSlashSlash?"//":h.commentHash?"#":"--",closeBrackets:"()[]{}''\"\"``"}});(function(){function l(a){for(var f;null!=(f=a.next());)if("`"==f&&!a.eat("`"))return"variable-2";a.backUp(a.current().length-1);return a.eatWhile(/\w/)?"variable-2":null}function g(a){a.eat("@")&&(a.match(/^session\./),a.match(/^local\./),a.match(/^global\./));return a.eat("'")?(a.match(/^.*'/),"variable-2"):a.eat('"')?(a.match(/^.*"/),"variable-2"):a.eat("`")?
