...
<div class="block" data-widget-section="onlineNow"' . $__templater->func('widget_data', array($__vars['widget'], ), true) . '>
	...
	$__finalCompiled .= '
		...
		<div class="block-footer">
			<span class="block-footer-counter">' . 'Total:&nbsp;' . $__templater->func('number', array($__vars['online']['counts']['total'], ), true) . ' (membros:&nbsp;' . $__templater->func('number', array($__vars['online']['counts']['members'], ), true) . ', visitantes:&nbsp;' . $__templater->func('number', array($__vars['online']['counts']['guests'], ), true) . ')' . '</span>
		</div>
	</div>
</div>';
