...
return array('macros' => array('visitor_panel_row' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canUploadAvatar', array())) {
		$__finalCompiled .= '
						<a class="avatarWrapper-update" href="' . $__templater->func('link', array('account/avatar', ), true) . '" data-xf-click="overlay"><span>' . 'Editar' . '</span></a>
					';
	}
	$__finalCompiled .= '
				</span>
	...
	<h4 class="menu-tabHeader tabs" data-xf-init="tabs" role="tablist">
		<span class="hScroller" data-xf-init="h-scroller">
			<span class="hScroller-scroll">
				<a href="' . $__templater->func('link', array('account', ), true) . '" class="tabs-tab is-active" role="tab" tabindex="0" aria-controls="' . $__templater->func('unique_id', array('accountMenu', ), true) . '">' . 'Sua conta' . '</a>
			' . $__compilerTemp1 . '
			</span>
		</span>
	</h4>
...
';
	...
	if ($__vars['xf']['options']['enableNewsFeed']) {
		$__compilerTemp2 .= '
			<li><a href="' . $__templater->func('link', array('whats-new/news-feed', ), true) . '" class="menu-linkRow">' . 'Feed de Notícias' . '</a></li>
		';
	}
	$__compilerTemp3 = '';
	if ($__templater->method($__vars['xf']['visitor'], 'canEditSignature', array())) {
		$__compilerTemp3 .= '
			<li><a href="' . $__templater->func('link', array('account/signature', ), true) . '" class="menu-linkRow">' . 'Assinatura' . '</a></li>
		';
	}
	$__compilerTemp4 = '';
	...
	if ($__vars['xf']['app']['connectedAccountCount']) {
		$__compilerTemp5 .= '
			<li><a href="' . $__templater->func('link', array('account/connected-accounts', ), true) . '" class="menu-linkRow">' . 'Contas conectadas' . '</a></li>
		';
	}
	$__compilerTemp6 = '';
	if ($__templater->method($__vars['xf']['visitor'], 'canPostOnProfile', array())) {
		...
		' . $__templater->form('
			...
			<span class="u-srOnly" id="ctrl_message">' . 'Atualizar seu status' . $__vars['xf']['language']['label_separator'] . '</span>
			' . $__templater->formTextArea(array(
			'name' => 'message',
			'rows' => '1',
			'autosize' => 'true',
			'maxlength' => $__vars['xf']['options']['profilePostMaxLength'],
			'placeholder' => 'Atualizar seu status' . $__vars['xf']['language']['ellipsis'],
	...
	<ul class="listPlain listColumns listColumns--narrow listColumns--together">
		' . '
		' . $__compilerTemp2 . '
		<li><a href="' . $__templater->func('link', array('search/member', null, array('user_id' => $__vars['xf']['visitor']['user_id'], ), ), true) . '" class="menu-linkRow">' . 'Seu conteúdo' . '</a></li>
	...
	<ul class="listPlain listColumns listColumns--narrow listColumns--together">
		' . '
		<li><a href="' . $__templater->func('link', array('account/account-details', ), true) . '" class="menu-linkRow">' . 'Detalhes da conta' . '</a></li>
		<li><a href="' . $__templater->func('link', array('account/security', ), true) . '" class="menu-linkRow">' . 'Senha e segurança' . '</a></li>
		<li><a href="' . $__templater->func('link', array('account/privacy', ), true) . '" class="menu-linkRow">' . 'Privacidade' . '</a></li>
		<li><a href="' . $__templater->func('link', array('account/preferences', ), true) . '" class="menu-linkRow">' . 'Preferências' . '</a></li>
		' . $__compilerTemp3 . '
		' . $__compilerTemp4 . '
		' . $__compilerTemp5 . '
		<li><a href="' . $__templater->func('link', array('account/following', ), true) . '" class="menu-linkRow">' . 'Seguindo' . '</a></li>
		<li><a href="' . $__templater->func('link', array('account/ignored', ), true) . '" class="menu-linkRow">' . 'Ignorando' . '</a></li>
		' . '
	</ul>
	...
	<a href="' . $__templater->func('link', array('logout', null, array('t' => $__templater->func('csrf_token', array(), false), ), ), true) . '" class="menu-linkRow">' . 'Sair' . '</a>
		...
		if ($__templater->method($__vars['xf']['visitor'], 'canViewBookmarks', array())) {
			...
			<li role="tabpanel" id="' . $__templater->func('unique_id', array('accountMenuBookmarks', ), true) . '"
				...
				<div class="menu-footer menu-footer--close">
					<a href="' . $__templater->func('link', array('account/bookmarks', ), true) . '">' . 'Mostrar todos' . $__vars['xf']['language']['ellipsis'] . '</a>
				</div>
			</li>
		';
		}
