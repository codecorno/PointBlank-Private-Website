...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	$__finalCompiled .= $__templater->callMacro('approval_queue_macros', 'item_message_type', array(
		...
		'typePhraseHtml' => 'Post de perfil',
		'spamDetails' => $__vars['spamDetails'],
		'unapprovedItem' => $__vars['unapprovedItem'],
		'handler' => $__vars['handler'],
		'headerPhraseHtml' => 'Postado no perfil de <a href="' . $__templater->func('link', array('profile-posts', $__vars['content'], ), false) . '">' . $__vars['content']['ProfileUser']['username'] . '</a>',
	), $__vars);
