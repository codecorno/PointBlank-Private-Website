...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	$__finalCompiled .= $__templater->callMacro('approval_queue_macros', 'item_message_type', array(
		...
		'headerPhraseHtml' => 'Postou um tópico <a href="' . $__templater->func('link', array('posts', $__vars['content'], ), false) . '">' . $__vars['content']['Thread']['title'] . '</a> no fórum <a href="' . $__templater->func('link', array('forums', $__vars['content']['Thread']['Forum'], ), false) . '">' . $__vars['content']['Thread']['Forum']['title'] . '</a>',
	), $__vars) . '
';
