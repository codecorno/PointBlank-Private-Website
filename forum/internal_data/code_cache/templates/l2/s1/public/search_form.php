...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Pesquisar');
	$__finalCompiled .= '
	...
	<div class="block-container">
		<h2 class="block-tabHeader tabs hScroller" data-xf-init="h-scroller">
			<span class="hScroller-scroll">
				<a href="' . $__templater->func('link', array('search', ), true) . '" class="tabs-tab' . ((!$__vars['type']) ? ' is-active' : '') . '">' . 'Pesquisar tudo' . '</a>
				' . $__compilerTemp1 . '
				' . $__compilerTemp2 . '
			</span>
		</h2>
