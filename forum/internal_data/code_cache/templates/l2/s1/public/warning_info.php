...
'expire' => function($__templater, array $__arguments, array $__vars)
{
	...
	array(
		'value' => 'future',
		'label' => 'Expira em' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array('
...
<div class="form block">
	...
	if ($__vars['warning']['is_expired']) {
		$__compilerTemp3 .= '
					<span class="u-muted">' . $__vars['xf']['language']['parenthesis_open'] . 'Expirado' . $__vars['xf']['language']['parenthesis_close'] . '</span>
				';
	} else if ($__vars['warning']['expiry_date']) {
		$__compilerTemp3 .= '
					<span class="u-muted">' . $__vars['xf']['language']['parenthesis_open'] . 'Expira ' . $__templater->func('date', array($__vars['warning']['expiry_date'], ), true) . '' . $__vars['xf']['language']['parenthesis_close'] . '</span>
				';
	}
	$__finalCompiled .= $__templater->formRow('
	...
	if ($__templater->method($__vars['warning'], 'canDelete', array()) AND $__templater->method($__vars['warning'], 'canEditExpiry', array())) {
		$__finalCompiled .= '
			<h2 class="block-tabHeader tabs" data-xf-init="tabs" role="tablist">
				<a class="tabs-tab is-active" role="tab" tabindex="0" aria-controls="' . $__templater->func('unique_id', array('warningDelete', ), true) . '">' . 'Excluir alerta' . '</a>
