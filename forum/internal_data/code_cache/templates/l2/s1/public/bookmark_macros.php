	...
	<div class="contentRow-extra">
		...
		<div class="menu" data-menu="menu" aria-hidden="true">
			<div class="menu-content">
				...
				<a href="' . $__templater->escape($__vars['bookmark']['edit_link']) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Editar' . '</a>
				<a href="' . $__templater->escape($__vars['bookmark']['delete_link']) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Excluir' . '</a>
			</div>
		</div>
	</div>
';
	...
	if ($__vars['bookmark']['content_user'] OR $__templater->method($__vars['content'], 'isValidKey', array('username', ))) {
		$__finalCompiled .= '
			...
			'title' => 'Usuário',
					...
					<span class="u-srOnly">' . 'Usuário' . '</span>
