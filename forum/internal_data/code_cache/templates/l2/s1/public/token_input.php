...
jQuery.extend(XF.phrases, {
	s2_error_loading: "' . $__templater->filter('Não foi possível carregar os resultados.', array(array('escape', array('js', )),), false) . '",
	s2_input_too_long: "' . $__templater->filter('Please delete {count} character(s).', array(array('escape', array('js', )),), false) . '",
	s2_input_too_short: "' . $__templater->filter('Digite {count} ou mais caracteres.', array(array('escape', array('js', )),), false) . '",
	s2_loading_more: "' . $__templater->filter('Carregando mais resultados...', array(array('escape', array('js', )),), false) . '",
	s2_maximum_selected: "' . $__templater->filter('Você só pode selecionar {count} item(ns).', array(array('escape', array('js', )),), false) . '",
	s2_no_results: "' . $__templater->filter('Nenhum resultado encontrado.', array(array('escape', array('js', )),), false) . '",
	s2_searching: "' . $__templater->filter('Pesquisando...', array(array('escape', array('js', )),), false) . '"
});
');
