...
' . '<p>' . $__templater->escape($__vars['sender']['username']) . ' adicionou você a uma conversa existente em ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '
...
<tr>
	<td>
		<a href="' . $__templater->func('link', array('canonical:conversations', $__vars['conversation'], ), true) . '" class="button">' . 'Ver esta conversa' . '</a>
	</td>
