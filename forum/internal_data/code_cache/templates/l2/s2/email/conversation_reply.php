...
' . '<p>' . (((('<a href="' . $__templater->func('link', array('canonical:members', $__vars['sender'], ), true)) . '">') . $__templater->escape($__vars['sender']['username'])) . '</a>') . ' respondeu à sua conversa em ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '
...
<tr>
	<td>
		<a href="' . $__templater->func('link', array('canonical:conversations/unread', $__vars['conversation'], ), true) . '" class="button">' . 'Ver esta conversa' . '</a>
	</td>
	<td align="' . ($__vars['xf']['isRtl'] ? 'left' : 'right') . '">
		<a href="' . $__templater->func('link', array('canonical:conversations', ), true) . '" class="buttonFake">' . 'Ver todas as suas conversas' . '</a>
	</td>
</tr>
</table>
