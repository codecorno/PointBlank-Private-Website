...
return array('macros' => array('item' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['userConv']['is_starred']) {
		$__compilerTemp1 .= '
						<li>
							<i class="structItem-status structItem-status--starred" aria-hidden="true" title="' . $__templater->filter('Com estrela', array(array('for_attr', array()),), true) . '"></i>
							<span class="u-srOnly">' . 'Com estrela' . '</span>
						</li>
					';
	}
	$__compilerTemp1 .= '
