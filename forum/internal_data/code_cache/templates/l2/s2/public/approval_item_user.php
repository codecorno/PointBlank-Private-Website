...
,array(
	...
	$__compilerTemp5[] = array(
		...
		'title' => 'Os usuários rejeitados não serão excluídos, mas seu estado de usuário será definido como "rejeitado". Se um motivo for fornecido acima, ele será exibido quando o próximo login.',
	...
	' . $__templater->formCheckBox(array(
		...
		'label' => '
			' . 'Notificar o usuário se a ação foi tomada' . '
		',
		'_type' => 'option',
	))) . '
