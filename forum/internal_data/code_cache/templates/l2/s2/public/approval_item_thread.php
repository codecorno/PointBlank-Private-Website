...
' . $__templater->callMacro('approval_queue_macros', 'item_message_type', array(
		...
		'typePhraseHtml' => 'Tópicos',
		'spamDetails' => $__vars['spamDetails'],
		'unapprovedItem' => $__vars['unapprovedItem'],
		'handler' => $__vars['handler'],
		'headerPhraseHtml' => 'Tópico <a href="' . $__templater->func('link', array('threads', $__vars['content'], ), false) . '">' . $__vars['content']['title'] . '</a> postado no fórum <a href="' . $__templater->func('link', array('forums', $__vars['content']['Forum'], ), false) . '">' . $__vars['content']['Forum']['title'] . '</a>',
	), $__vars);
