...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Conteúdo reportado' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['report']['title']));
	$__finalCompiled .= '
';
	...
	if ($__vars['report']['link']) {
		$__finalCompiled .= '
			<div class="block-footer">
				<span class="block-footer-controls">' . $__templater->button('Ir para o conteúdo', array(
...
<div class="block">
	<div class="block-container">
		<h3 class="block-header">' . 'Comentários' . '</h3>
...
<div class="block">
	...
	if ($__templater->method($__vars['report'], 'isClosed', array())) {
		$__compilerTemp2 .= 'Seu comentário reabrirá este relatório.';
	}
	$__compilerTemp3 = '';
	if (!$__templater->method($__vars['report'], 'isClosed', array())) {
		$__compilerTemp3 .= '
		...
		array(
			...
			'explain' => 'Qualquer texto de alerta de resolução/rejeição será anexado automaticamente ao comentário atual.',
		)) . '
							';
	}
	$__finalCompiled .= $__templater->form('
		...
		'label' => 'Mensagem',
		'explain' => '
									' . 'Seu comentário só será visível para os moderadores.' . '
									' . $__compilerTemp2 . '
								',
	)) . '
