<?php
// FROM HASH: b71bee09cfc662301e057317e3a7ece3
...
'sub_nodes_flat' => function($__templater, array $__arguments, array $__vars)
{
	...
	if (strlen(trim($__compilerTemp1)) > 0) {
		...
		<div class="node-subNodesFlat">
			<span class="node-subNodesLabel">' . 'Sub-fóruns' . $__vars['xf']['language']['label_separator'] . '</span>
...
'sub_nodes_menu' => function($__templater, array $__arguments, array $__vars)
{
	...
	if (strlen(trim($__compilerTemp1)) > 0) {
		...
		<div class="node-subNodeMenu">
			<a class="menuTrigger" data-xf-click="menu" role="button" tabindex="0" aria-expanded="false" aria-haspopup="true">' . 'Sub-fóruns' . '</a>
			<div class="menu" data-menu="menu" aria-hidden="true">
				<div class="menu-content">
					<h4 class="menu-header">' . 'Sub-fóruns' . '</h4>
...
';
	if ($__vars['xf']['options']['forumsDefaultPage'] != 'forums') {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Lista de fóruns');
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
