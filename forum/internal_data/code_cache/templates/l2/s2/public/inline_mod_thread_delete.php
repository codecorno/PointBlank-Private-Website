...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Moderação inline - Excluir tópicos');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('Tem certeza de que deseja excluir ' . $__templater->escape($__vars['total']) . ' tópico(s)?', array(
		'rowtype' => 'confirm',
	)) . '
