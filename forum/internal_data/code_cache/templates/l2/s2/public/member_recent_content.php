...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Conteúdo recente por ' . $__templater->escape($__vars['user']['username']) . '');
	$__finalCompiled .= '
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . '' . $__templater->escape($__vars['user']['username']) . ' não postou nenhum conteúdo recentemente.' . '</div>
';
	}
