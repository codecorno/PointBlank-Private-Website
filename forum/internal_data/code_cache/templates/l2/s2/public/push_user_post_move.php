...
{
	$__finalCompiled = '';
	$__finalCompiled .= 'Seu post no tópico ' . $__templater->escape($__vars['extra']['title']) . ' foi movido para ' . ($__templater->func('prefix', array('thread', $__vars['extra']['prefix_id'], 'plain', ), true) . $__templater->escape($__vars['extra']['targetTitle'])) . '.' . '
';
