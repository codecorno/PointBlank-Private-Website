...
';
	...
	<ul class="listInline listInline--bullet">
		...
		'title' => $__templater->filter('Participantes', array(array('for_attr', array()),), false),
	)) . '
			<span class="u-srOnly">' . 'Participantes' . '</span>
...
';
	...
	<div class="block">
		<div class="block-container">
			<h3 class="block-minorHeader">' . 'Informações de conversa' . '</h3>
			<div class="block-body block-row block-row--minor">
				<dl class="pairs pairs--justified"><dt>' . 'Participantes' . '</dt> <dd>' . $__templater->filter($__vars['conversation']['recipient_count'], array(array('number', array()),), true) . '</dd></dl>
				<dl class="pairs pairs--justified"><dt>' . 'Respostas' . '</dt> <dd>' . $__templater->filter($__vars['conversation']['reply_count'], array(array('number', array()),), true) . '</dd></dl>
				<dl class="pairs pairs--justified"><dt>' . 'Última resposta' . '</dt> <dd>' . $__templater->func('date_dynamic', array($__vars['conversation']['last_message_date'], array(
	))) . '</dd></dl>
				<dl class="pairs pairs--justified"><dt>' . 'Última resposta de' . '</dt> <dd>' . $__templater->func('username_link', array($__vars['conversation']['LastMessageUser'], false, array(
	))) . '</dd></dl>
			</div>
		</div>
	</div>
...
';
		...
		$__compilerTemp4 .= '
				<div class="block-footer">
					<span class="block-footer-controls">
						<a href="' . $__templater->func('link', array('conversations/invite', $__vars['conversation'], ), true) . '" data-xf-click="overlay">' . 'Convidar mais' . '</a>
					</span>
				</div>
			';
	}
	...
	<div class="block">
		<div class="block-container">
			<h3 class="block-minorHeader">' . 'Participantes da conversa' . '</h3>
			<ol class="block-body">
				' . $__compilerTemp3 . '
			</ol>
			' . $__compilerTemp4 . '
...
<div class="block block--messages">
	...
	$__finalCompiled .= '
				' . $__templater->button('
					' . ($__vars['userConv']['is_starred'] ? 'Desmarcar' : 'Star') . '
				', array(
		'href' => $__templater->func('link', array('conversations/star', $__vars['conversation'], ), false),
		'class' => 'button--link',
		'data-xf-click' => 'switch',
		'data-sk-star' => 'Star',
		'data-sk-unstar' => 'Desmarcar',
	), '', array(
	)) . '
				' . $__templater->button('
					' . ($__vars['userConv']['is_unread'] ? 'Marcar com lido' : 'Marcar como não lido') . '
				', array(
		'href' => $__templater->func('link', array('conversations/mark-unread', $__vars['conversation'], ), false),
		'class' => 'button--link',
		'data-xf-click' => 'switch',
		'data-sk-read' => 'Marcar com lido',
		'data-sk-unread' => 'Marcar como não lido',
	), '', array(
	)) . '
				' . $__templater->button('
					' . 'Deixar' . '
