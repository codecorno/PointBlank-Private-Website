...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if (!$__templater->test($__vars['prefixes'], 'empty', array())) {
		...
		<div class="menu-row menu-row--separated">
			' . 'Prefixo' . $__vars['xf']['language']['label_separator'] . '
			...
			'name' => 'prefix_id',
			'noneLabel' => $__vars['xf']['language']['parenthesis_open'] . 'Qualquer' . $__vars['xf']['language']['parenthesis_close'],
		), $__vars) . '
			</div>
		</div>
	';
	...
	' . '
	<div class="menu-row menu-row--separated">
		<label for="ctrl_started_by">' . 'Iniciado por' . $__vars['xf']['language']['label_separator'] . '</label>
		<div class="u-inputSpacer">
	...
	' . '
	<div class="menu-row menu-row--separated">
		<label for="ctrl_last_updated">' . 'Ultima atualização' . $__vars['xf']['language']['label_separator'] . '</label>
		<div class="u-inputSpacer">
			' . $__compilerTemp2 . '
	...
	' . '
	<div class="menu-row menu-row--separated">
		' . 'Ordenar por' . $__vars['xf']['language']['label_separator'] . '
