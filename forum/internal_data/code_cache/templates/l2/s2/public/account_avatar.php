...
';
		...
		$__compilerTemp1 .= '
			...
			'value' => '1',
									...
									<dfn class="inputChoices-explain">
										' . 'Digite o endereço de e-mail do Gravatar que você deseja usar.' . '
	...
	<div class="block-container">
		...
		'hint' => 'Arraste esta imagem para recortá-la e, em seguida, clique em <i>Ok</i> para confirmar ou carregue um novo avatar abaixo.',
		'_dependent' => array('
