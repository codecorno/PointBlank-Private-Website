...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	<a href="' . $__templater->func('link', array('full:attachments', array('attachment_id' => $__vars['id'], ), ), true) . '" target="_blank">' . 'Ver anexo ' . $__templater->escape($__vars['id']) . '' . '</a>
');
...
');
		...
		$__finalCompiled .= trim('
	<a href="' . $__templater->func('link', array('full:attachments', $__vars['attachment'], array('hash' => $__vars['attachment']['temp_hash'], ), ), true) . '" target="_blank">' . 'Ver anexo ' . $__templater->escape($__vars['attachment']['filename']) . '' . '</a>
');
