...
';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Moderação inline - Mover tópicos');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Tem certeza de que deseja mover ' . $__templater->escape($__vars['total']) . ' tópico(s)?', array(
		'rowtype' => 'confirm',
	)) . '
		...
		'label' => 'Aplicar prefixo aos tópicos selecionados',
		'_dependent' => array('
