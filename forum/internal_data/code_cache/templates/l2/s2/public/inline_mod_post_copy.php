...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Tem certeza de que deseja copiar ' . $__templater->escape($__vars['total']) . ' post(s) para um novo tópico?', array(
		'rowtype' => 'confirm',
	)) . '
		...
		'label' => 'Novo tópico',
		'_dependent' => array('
						<label>' . 'Fórum de destino' . $__vars['xf']['language']['label_separator'] . '</label>
		...
		'class' => 'js-nodeList',
					...
					', '
						<label>' . 'Novo título do tópico' . $__vars['xf']['language']['label_separator'] . '</label>
	...
	array(
		'value' => 'existing',
		'labelclass' => 'u-featuredText',
		'label' => 'Tópico existente',
		'_dependent' => array('
						<label>' . 'URL do tópico' . $__vars['xf']['language']['label_separator'] . '</label>
