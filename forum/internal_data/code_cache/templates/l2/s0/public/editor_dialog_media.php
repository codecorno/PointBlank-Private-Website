...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Inserir mídia');
	$__finalCompiled .= '
...
<form class="block" id="editor_media_form">
	...
	$__finalCompiled .= $__templater->formRow('
				...
				<div class="formRow-explain">
					<a href="' . $__templater->func('link', array('help', array('page_name' => 'bb-codes', ), ), true) . '#media" target="_blank">' . 'Ajuda' . '</a>
				</div>
			', array(
		'label' => 'Sites aprovados',
