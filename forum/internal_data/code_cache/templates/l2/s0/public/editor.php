...
';
	...
	<script class="js-editorLanguage" type="application/json">
		{
			"Align Center": "' . $__templater->filter('Centralizado', array(array('escape', array('json', )),), true) . '",
			"Align Left": "' . $__templater->filter('Alinhar à esquerda', array(array('escape', array('json', )),), true) . '",
			"Align Right": "' . $__templater->filter('Alinhar à direita', array(array('escape', array('json', )),), true) . '",
			"Align": "' . $__templater->filter('Alinhamento', array(array('escape', array('json', )),), true) . '",
			"Alignment": "' . $__templater->filter('Alinhamento', array(array('escape', array('json', )),), true) . '",
			"Back": "' . $__templater->filter('Voltar', array(array('escape', array('json', )),), true) . '",
			...
			"Clear Formatting": "' . $__templater->filter('Remover formatação', array(array('escape', array('json', )),), true) . '",
			"Code": "' . $__templater->filter('Código', array(array('escape', array('json', )),), true) . '",
			"Colors": "' . $__templater->filter('Cor de texto', array(array('escape', array('json', )),), true) . '",
			"Decrease Indent": "' . $__templater->filter('Avançado', array(array('escape', array('json', )),), true) . '",
			"Delete Draft": "' . $__templater->filter('Excluir rascunho', array(array('escape', array('json', )),), true) . '",
			"Drafts": "' . $__templater->filter('Rascunhos', array(array('escape', array('json', )),), true) . '",
			...
			"Edit Link": "' . $__templater->filter('Editar link', array(array('escape', array('json', )),), true) . '",
			"Font Family": "' . $__templater->filter('Fonte', array(array('escape', array('json', )),), true) . '",
			"Font Size": "' . $__templater->filter('Tamanho da fonte', array(array('escape', array('json', )),), true) . '",
			"Increase Indent": "' . $__templater->filter('Recuado', array(array('escape', array('json', )),), true) . '",
			"Inline Code": "' . $__templater->filter('Código em linha', array(array('escape', array('json', )),), true) . '",
			"Inline Spoiler": "' . $__templater->filter('Inline spoiler', array(array('escape', array('json', )),), true) . '",
			"Insert Image": "' . $__templater->filter('Inserir imagem', array(array('escape', array('json', )),), true) . '",
			"Insert Link": "' . $__templater->filter('Inserir link', array(array('escape', array('json', )),), true) . '",
			"Insert": "' . $__templater->filter('Inserir', array(array('escape', array('json', )),), true) . '",
			"Italic": "' . $__templater->filter('Itálico', array(array('escape', array('json', )),), true) . '",
			...
			"Open Link": "' . $__templater->filter('Abrir link', array(array('escape', array('json', )),), true) . '",
			"or click": "' . $__templater->filter('Or click here', array(array('escape', array('json', )),), true) . '",
			"Ordered List": "' . $__templater->filter('Lista ordenada', array(array('escape', array('json', )),), true) . '",
			"Quote": "' . $__templater->filter('Quote', array(array('escape', array('json', )),), true) . '",
			"Redo": "' . $__templater->filter('Refazer', array(array('escape', array('json', )),), true) . '",
			"Remove": "' . $__templater->filter('Remover', array(array('escape', array('json', )),), true) . '",
			"Replace": "' . $__templater->filter('Substituir', array(array('escape', array('json', )),), true) . '",
			"Save Draft": "' . $__templater->filter('Salvar rascunho', array(array('escape', array('json', )),), true) . '",
			"Smilies": "' . $__templater->filter('Smilies', array(array('escape', array('json', )),), true) . '",
			"Something went wrong. Please try again.": "' . $__templater->filter('Algo deu errado. Tente novamente ou entre em contato com o administrador.', array(array('escape', array('json', )),), true) . '",
			"Spoiler": "' . $__templater->filter('Spoiler', array(array('escape', array('json', )),), true) . '",
			"Strikethrough": "' . $__templater->filter('Riscado', array(array('escape', array('json', )),), true) . '",
			"Text": "' . $__templater->filter('Texto', array(array('escape', array('json', )),), true) . '",
			"Toggle BB Code": "' . $__templater->filter('Reduzir BBcode', array(array('escape', array('json', )),), true) . '",
			"Underline": "' . $__templater->filter('Sublinhado', array(array('escape', array('json', )),), true) . '",
			"Undo": "' . $__templater->filter('Desfazer', array(array('escape', array('json', )),), true) . '",
			"Unlink": "' . $__templater->filter('Remover link', array(array('escape', array('json', )),), true) . '",
			"Unordered List": "' . $__templater->filter('Lista desordenada', array(array('escape', array('json', )),), true) . '",
			...
			"Width": "' . $__templater->filter('Largura', array(array('escape', array('json', )),), true) . '",
			"Height": "' . $__templater->filter('Altura', array(array('escape', array('json', )),), true) . '",
			"Change Size": "' . $__templater->filter('Change size', array(array('escape', array('json', )),), true) . '",
			"None": "' . $__templater->filter('Nenhuma', array(array('escape', array('json', )),), true) . '",
	...
	<textarea name="' . $__templater->escape($__vars['htmlName']) . '"
		...
		aria-label="' . $__templater->filter('Caixa de texto rica', array(array('for_attr', array()),), true) . '"
	...
	<noscript>
		<textarea name="' . $__templater->escape($__vars['name']) . '" class="input" aria-label="' . $__templater->filter('Caixa de texto rica', array(array('for_attr', array()),), true) . '">' . $__templater->escape($__vars['value']) . '</textarea>
	</noscript>
