...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Itens reportados');
	$__finalCompiled .= '
...
<div class="block">
	...
	<div class="block-container">
		<h2 class="block-tabHeader tabs">
			<a href="' . $__templater->func('link', array('reports', ), true) . '" class="tabs-tab is-active">' . 'Relatórios ativos' . '</a>
			<a href="' . $__templater->func('link', array('reports/closed', ), true) . '" class="tabs-tab">' . 'Relatórios fechados' . '</a>
		</h2>
	...
	if (!$__templater->test($__vars['openReports'], 'empty', array())) {
		...
		$__finalCompiled .= '
				<div class="block-row">' . 'Não há relatórios ativos que exigem sua atenção.' . '</div>
			';
	}
	$__finalCompiled .= '
		</div>
	...
	if (!$__templater->test($__vars['closedReports'], 'empty', array())) {
		...
		<div class="block-container">
			<h3 class="block-header">
				' . 'Relatórios fechados recentemente' . '
			</h3>
			<div class="block-body">
				<div class="structItemContainer">
					';
