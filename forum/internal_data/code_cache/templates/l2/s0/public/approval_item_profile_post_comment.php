...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	$__finalCompiled .= $__templater->callMacro('approval_queue_macros', 'item_message_type', array(
		...
		'headerPhraseHtml' => 'Postado no post do perfil por <a href="' . $__templater->func('link', array('profile-posts/comments', $__vars['content'], ), false) . '">' . $__vars['content']['ProfilePost']['username'] . '</a>',
	), $__vars);
