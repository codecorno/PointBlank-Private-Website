...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Preferências');
	$__finalCompiled .= '
...
';
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canChangeStyle', array())) {
		...
		$__compilerTemp2 = array(array(
			'value' => '0',
			'label' => 'Usar estilo padrão' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['defaultStyle']['title']),
			'_type' => 'option',
		));
		$__compilerTemp2[] = array(
			'label' => 'Estilos' . $__vars['xf']['language']['label_separator'],
			'_type' => 'optgroup',
			'options' => array(),
		);
	...
	if ($__vars['xf']['options']['enableNotices'] AND ($__templater->func('count', array($__vars['xf']['session']['dismissedNotices'], ), false) > 0)) {
		$__compilerTemp8 .= '
			...
			'label' => 'Restaurar avisos dispensados',
			'hint' => 'Quaisquer avisos que você tenha dispensado anteriormente serão restaurados para ver se você marcar essa opção.',
			'_type' => 'option',
		)), array(
		)) . '
			';
	...
	<div class="block-container">
		...
		'label' => 'Seguir automaticamente o conteúdo criado' . $__vars['xf']['language']['ellipsis'],
	...
	array(
		...
		'label' => 'Seguir automaticamente ao conteúdo que você interage' . $__vars['xf']['language']['ellipsis'],
		'_dependent' => array($__templater->formCheckBox(array(
	), array(array(
		'value' => 'watch_email',
		'name' => 'option[interaction_watch_state]',
	...
	array(
		...
		'label' => 'Mostrar as assinaturas das pessoas com as suas mensagens',
		'_type' => 'option',
	)), array(
