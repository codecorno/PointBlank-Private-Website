...
return array('macros' => array('editor_setup' => function($__templater, array $__arguments, array $__vars)
{
	...
	<script class="js-codeEditorLanguage" type="application/json">
		{
			"All": "' . $__templater->filter('Todos', array(array('escape', array('json', )),), true) . '",
			...
			"No": "' . $__templater->filter('Não', array(array('escape', array('json', )),), true) . '",
			...
			"Replace:": "' . $__templater->filter('Substituir' . $__vars['xf']['language']['label_separator'], array(array('escape', array('json', )),), true) . '",
			...
			"Search:": "' . $__templater->filter('Pesquisar' . $__vars['xf']['language']['label_separator'], array(array('escape', array('json', )),), true) . '",
			...
			"Yes": "' . $__templater->filter('Sim', array(array('escape', array('json', )),), true) . '"
		}
	</script>
	';
