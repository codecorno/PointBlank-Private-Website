...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Última atividade de ' . $__templater->escape($__vars['user']['username']) . '');
	$__finalCompiled .= '
...
';
	...
	<div class="blockMessage">
		' . '' . $__templater->escape($__vars['user']['username']) . ' restringiu quem pode ver sua atividade mais recente.' . '
	</div>
';
	} else {
		$__finalCompiled .= '
		...
		if (!$__templater->test($__vars['newsFeedItems'], 'empty', array())) {
			...
			$__finalCompiled .= '
				<div class="block-body js-newsFeedTarget">
					<div class="block-row block-row--separated">' . 'Não há mais itens para mostrar.' . '</div>
				</div>
			';
		} else {
			$__finalCompiled .= '
				<div class="block-body js-newsFeedTarget">
					<div class="block-row">' . 'O feed de notícias está vazio.' . '</div>
				</div>
			';
		}
		$__finalCompiled .= '
