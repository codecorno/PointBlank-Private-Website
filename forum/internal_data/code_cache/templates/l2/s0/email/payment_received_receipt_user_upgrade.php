...
{
	$__finalCompiled = '';
	$__finalCompiled .= '<mail:subject>' . 'Recebimento para a atualização da sua conta em ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . '' . '</mail:subject>
...
<p><a href="' . $__templater->func('link', array('canonical:account/upgrades', ), true) . '" class="button">' . 'Gerenciar atualizações da sua conta' . '</a></p>
