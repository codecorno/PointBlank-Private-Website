...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Provedores de contas conectadas');
	$__finalCompiled .= '
...
<div class="block">
	...
	if (!$__templater->test($__vars['activeProviders'], 'empty', array())) {
		...
		$__finalCompiled .= '
			<!--<div class="block-body block-row">' . 'Ainda não existem provedores ativos.' . '</div>-->
		';
	}
	$__finalCompiled .= '
