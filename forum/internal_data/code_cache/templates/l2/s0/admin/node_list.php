...
';
	...
	<div class="buttonGroup">
		' . $__templater->button('Adicionar nó', array(
...
,array(
				...
				if ($__vars['moderators'][$__vars['node']['node_id']]) {
					...
					$__compilerTemp3[] = array(
						...
						'label' => 'Moderadores (' . $__templater->func('count', array($__vars['moderators'][$__vars['node']['node_id']], ), false) . ')',
						'_type' => 'popup',
						'html' => '

									<div class="menu" data-menu="menu" aria-hidden="true">
										<div class="menu-content">
											<h3 class="menu-header">' . 'Moderadores' . '</h3>
											' . $__compilerTemp4 . '
											<hr class="menu-separator" />
											<a href="' . $__templater->func('link', array('moderators/add', null, array('type' => 'node', 'type_id' => array('node' => $__vars['node']['node_id'], ), ), ), true) . '" class="menu-linkRow">' . 'Adicionar moderador' . '</a>
										</div>
									</div>
								',
					);
					...
					$__compilerTemp3[] = array(
						...
						'class' => 'u-hideMedium',
						'_type' => 'action',
						'html' => 'Adicionar moderador',
					);
				}
				$__compilerTemp3[] = array(
					'class' => 'dataList-cell--action u-hideMedium',
					'label' => 'Adicionar' . $__vars['xf']['language']['ellipsis'],
					'_type' => 'popup',
					'html' => '

								<div class="menu" data-menu="menu" aria-hidden="true">
									<div class="menu-content">
										<h3 class="menu-header">' . 'Adicionar' . $__vars['xf']['language']['ellipsis'] . '</h3>
