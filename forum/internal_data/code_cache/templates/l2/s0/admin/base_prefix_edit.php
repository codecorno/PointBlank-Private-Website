...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__templater->method($__vars['prefix'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Adicionar prefixo');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Editar prefixo' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['prefix']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
