	...
	if (!$__vars['errors']) {
		...
		if ($__vars['warnings']) {
			...
			<div class="block-body">
				...
				'label' => 'Revisei os avisos e ainda desejo continuar',
				'_type' => 'option',
			)), array(
...
'warnings' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['warnings']) {
		...
		<div class="block-rowMessage block-rowMessage--warning block-rowMessage--iconic">
			' . 'Para evitar possíveis problemas, resolva os seguintes avisos antes de continuar' . $__vars['xf']['language']['label_separator'] . '
			<ul>
				';
