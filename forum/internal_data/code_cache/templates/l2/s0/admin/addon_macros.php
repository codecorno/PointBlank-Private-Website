...
'addon_change_menu' => function($__templater, array $__arguments, array $__vars)
{
	...
	<a class="' . $__templater->escape($__vars['linkClass']) . ' menuTrigger"
		...
		tabindex="0"
		aria-expanded="false"
		aria-haspopup="true">' . 'Complemento' . $__vars['xf']['language']['label_separator'] . ' ' . ($__vars['currentAddOn'] ? $__templater->escape($__vars['currentAddOn']['title']) : $__vars['xf']['language']['parenthesis_open'] . 'Qualquer' . $__vars['xf']['language']['parenthesis_close']) . '</a>

	<div class="menu" data-menu="menu" aria-hidden="true">
		<div class="menu-content">
			<h3 class="menu-header">' . 'Complementos' . '</h3>
			<a href="' . $__templater->func('link', array($__vars['route'], $__vars['routeData'], array('addon_id' => null, ) + $__vars['routeParams'], ), true) . '"
				...
				' . $__vars['xf']['language']['parenthesis_open'] . 'Qualquer' . $__vars['xf']['language']['parenthesis_close'] . '
			</a>
			';
...
'addon_select' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['includeAny']) {
		$__compilerTemp1[] = array(
			'value' => '_any',
			'label' => $__vars['xf']['language']['parenthesis_open'] . 'Qualquer' . $__vars['xf']['language']['parenthesis_close'],
			'_type' => 'option',
		);
	}
