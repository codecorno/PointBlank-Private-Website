...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__templater->method($__vars['routeFilter'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Adicionar filtro de rota');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
...
' . $__templater->form('
	...
	array(
		...
		'hint' => 'Se selecionado, este filtro será usado apenas para alterar URLs de entrada, não URLs de rota de saída.',
		'_type' => 'option',
	)), array(
	)) . '
		</div>
