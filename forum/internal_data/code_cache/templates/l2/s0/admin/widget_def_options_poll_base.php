...
';
	...
	' . $__templater->formRow('
		<div class="blockMessage blockMessage--error blockMessage--iconic">' . 'A enquete para este conteúdo não pode ser encontrada. Ela pode ter sido excluída. Forneça um novo URL de conteúdo abaixo.' . '</div>
	', array(
		)) . '
