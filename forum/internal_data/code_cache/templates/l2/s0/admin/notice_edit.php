...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__templater->method($__vars['notice'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Adicionar aviso');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Editar aviso' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['notice']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
';
	...
	' . $__templater->button('Resetar', array(
...
';
	...
	<div class="block-container">
		...
		'explain' => 'A mensagem a ser exibida quando os critérios de exibição são atendidos. Você pode inserir <b>{name}</b> para ser substituído pelo nome de usuário do visitante atual e {title} para ser substituído pelo título deste aviso.',
	)) . '
	...
	array(
		'value' => 'avatar',
		'label' => 'Mostrar avatar do visitante',
		'_type' => 'option',
	),
	array(
		'value' => 'image',
		'label' => 'Especifique uma imagem' . $__vars['xf']['language']['label_separator'],
	...
	array(
		'value' => 'custom',
		'label' => 'Outro, usando o nome de classe CSS personalizado' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formTextBox(array(
		'name' => 'css_class',
	...
	array(
		...
		'label' => 'Duração da exibição (milissegundos)',
		...
		'label' => 'Duração do atraso (milissegundos)',
