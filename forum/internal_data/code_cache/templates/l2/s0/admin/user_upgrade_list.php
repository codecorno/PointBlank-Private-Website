...
,array(
				'_type' => 'cell',
				'html' => ($__vars['upgrade']['end_date'] ? $__templater->func('date', array($__vars['upgrade']['end_date'], ), true) : 'Permanente'),
			));
			if ($__vars['active']) {
...
';
		...
		if ($__templater->isTraversable($__vars['upgrades'])) {
			foreach ($__vars['upgrades'] AS $__vars['upgrade']) {
				$__compilerTemp1 .= '
					...
					'submit' => 'true',
					'tooltip' => 'Ativar / desativar \'' . $__vars['upgrade']['title'] . '\'',
					'_type' => 'toggle',
					'html' => '',
				),
				array(
					...
					'html' => '
								<div class="menu" data-menu="menu" aria-hidden="true">
									<div class="menu-content">
										...
										<a href="' . $__templater->func('link', array('user-upgrades/active', $__vars['upgrade'], ), true) . '" class="menu-linkRow">' . 'Ver usuários' . '</a>
		...
		if (!$__templater->test($__vars['activeUpgrades'], 'empty', array())) {
			$__finalCompiled .= '
				...
				<div class="block-footer block-footer--split">
					...
					<span class="block-footer-controls">' . $__templater->button('Ver mais' . $__vars['xf']['language']['ellipsis'], array(
			...
			$__finalCompiled .= '
				<div class="block-body block-row">' . 'Nenhum resultado encontrado.' . '</div>
			';
		}
		$__finalCompiled .= '
		</div>
	...
	<div class="block">
		<div class="block-container">
			<h2 class="block-header"><a href="' . $__templater->func('link', array('user-upgrades/expired', ), true) . '">' . 'Atualizações de usuário expiradas' . '</a></h2>
			';
