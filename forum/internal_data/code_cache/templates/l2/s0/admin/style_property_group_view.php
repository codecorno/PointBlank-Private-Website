...
';
	$__templater->breadcrumb($__templater->preEscaped($__templater->escape($__vars['style']['title']) . ' - ' . 'Propriedades de estilo'), $__templater->func('link', array('styles/style-properties', $__vars['style'], ), false), array(
	));
	$__finalCompiled .= '
	...
	';
		...
		<div class="block-outer">
			...
			'routeParams' => array('group' => $__vars['group']['group_name'], ),
				...
				' . $__templater->button('Grupo' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['group']['title']), array(
			...
			'aria-haspopup' => 'true',
				...
				<div class="menu" data-menu="menu" aria-hidden="true">
					<div class="menu-content">
						<h3 class="menu-header">' . 'Grupos' . '</h3>
