		...
		<div class="block-container">
			<div class="block-body">
				' . $__templater->formInfoRow('
					<div class="blockMessage blockMessage--important blockMessage--iconic">' . 'Nota: Excluir perfis de pagamento não afetará quaisquer compras (ou assinaturas) existentes que tenham sido feitas com esse perfil.' . '</div>
