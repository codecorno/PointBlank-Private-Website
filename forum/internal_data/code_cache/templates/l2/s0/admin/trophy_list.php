...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Troféus');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Adicionar troféu', array(
		...
		if ($__templater->isTraversable($__vars['trophies'])) {
			foreach ($__vars['trophies'] AS $__vars['trophy']) {
				$__compilerTemp1 .= '
					...
					'hint' => 'Pontos' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['trophy']['trophy_points']),
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Nenhum troféu foi criado ainda.' . '</div>
';
	}
	$__finalCompiled .= '
