...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('BBcode site de mídia');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Adicionar BBcode site de mídia', array(
...
,array(
					...
					'submit' => 'true',
					'tooltip' => 'Ativar / desativar \'' . $__vars['site']['site_title'] . '\'',
					'_type' => 'toggle',
					'html' => '',
				));
