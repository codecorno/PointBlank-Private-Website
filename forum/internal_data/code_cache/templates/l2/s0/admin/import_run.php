...
';
	...
	';
		...
		$__compilerTemp1 .= '
		' . 'Step ' . $__templater->escape($__vars['importCompletion']['current']) . ' of ' . $__templater->escape($__vars['importCompletion']['total']) . '' . $__vars['xf']['language']['label_separator'] . ' ' . 'Processando' . $__vars['xf']['language']['ellipsis'] . '
	';
	} else {
		$__compilerTemp1 .= '
		' . 'Processando' . $__vars['xf']['language']['ellipsis'] . '
	';
	}
	...
	<div class="u-noJsOnly">
		' . $__templater->button('Prosseguir' . $__vars['xf']['language']['ellipsis'], array(
		'type' => 'submit',
	), '', array(
	)) . '
	</div>
