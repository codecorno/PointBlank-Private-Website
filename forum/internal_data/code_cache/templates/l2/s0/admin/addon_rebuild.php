...
';
	...
	if ($__vars['errors']) {
		$__compilerTemp1 .= '
					' . 'Encontramos alguns erros ao tentar reconstruir os dados mestre do complemento a seguinte' . $__vars['xf']['language']['label_separator'] . '
				';
	} else if ($__vars['warnings']) {
		$__compilerTemp1 .= '
					' . 'Revise os avisos e confirme que deseja continuar a reconstruir os dados mestre do complemento a seguir' . $__vars['xf']['language']['label_separator'] . '
				';
	} else {
		$__compilerTemp1 .= '
					' . 'Confirme que você deseja recriar os dados mestre do complemento a seguir' . $__vars['xf']['language']['label_separator'] . '
				';
	}
