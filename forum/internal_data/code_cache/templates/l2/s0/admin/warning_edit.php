...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__templater->method($__vars['warning'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Adicionar alerta');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
...
';
	...
	array(
		'value' => 'other',
		'selected' => $__vars['warning']['expiry_type'] != 'never',
		'label' => 'Depois do tempo' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array('
	...
	array(
		...
		'label' => 'Grupos de usuários extras',
		'explain' => 'Um usuário que receber este aviso pode ser adicionado a grupos de usuários específicos até que o aviso tenha expirado.',
	)) . '
		</div>

		<h3 class="block-formSectionHeader"><span class="block-formSectionHeader-aligner">' . 'Configurações de conversas' . '</span></h3>
		<div class="block-body">
			' . $__templater->formTextBoxRow(array(
