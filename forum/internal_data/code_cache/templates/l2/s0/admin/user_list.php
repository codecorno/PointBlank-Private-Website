...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Usuários');
	$__finalCompiled .= '
	...
	';
		...
		if (!$__vars['showingAll']) {
			...
			<div class="block-outer">
				<div class="block-outer-main">
					' . $__templater->button('
						' . 'Ordenar por' . $__vars['xf']['language']['label_separator'] . ' ' . ($__templater->escape($__vars['sortOptions'][$__vars['order']]) ?: 'Nome de usuário') . '
					', array(
				...
				'aria-haspopup' => 'true',
					...
					<div class="menu" data-menu="menu" aria-hidden="true">
						<div class="menu-content">
							<h3 class="menu-header">' . 'Ordenar por' . $__vars['xf']['language']['ellipsis'] . '</h3>
							';
		...
		if ($__vars['filter'] AND ($__vars['total'] > $__vars['perPage'])) {
			$__compilerTemp6 .= '
				...
				'colspan' => '3',
				'_type' => 'cell',
				'html' => 'Há mais registros correspondentes ao seu filtro. Por favor, seja mais específico.' . '
							',
			))) . '
					';
		}
		...
		if ($__vars['showAll']) {
			$__compilerTemp7 .= '
					<span class="block-footer-controls"><a href="' . $__templater->func('link', array('users/list', null, array('criteria' => $__vars['criteria'], 'all' => true, ), ), true) . '">' . 'Mostrar todos os resultados' . '</a></span>
				';
