...
';
	...
	<div class="block-container">
		...
		'label' => 'Event hint',
		'explain' => 'Quando determinados eventos são acionados, eles serão disparados com uma dica. Esta dica pode ser usada para limitar o seu ouvinte a ser executado somente quando for necessário, aumentando o desempenho. Se um evento for acionado com uma dica, os valores de dica de potencial serão listados na descrição do evento acima. Se você especificar uma dica aqui, o ouvinte só será executado se sua dica corresponder à dica fornecida quando o evento é disparado. Se a dica for um nome de classe, você deve omitir o \\ carácter principal.',
	)) . '
