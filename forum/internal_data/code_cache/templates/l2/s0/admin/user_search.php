...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Procurar usuários');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Adicionar usuário', array(
	...
	<div class="blockMessage blockMessage--highlight">
		<div class="contentRow">
			...
			<div class="contentRow-main">
				<h2 class="contentRow-title">' . 'Mudanças salvas' . '</h2>
				<a href="' . $__templater->func('link', array('users/edit', $__vars['lastUser'], ), true) . '">' . 'Editar ' . $__templater->escape($__vars['lastUser']['username']) . ' novamente.' . '</a>
			</div>
		</div>
	</div>
';
...
<div class="block">
	<div class="block-container">
		<h2 class="block-tabHeader tabs" data-xf-init="tabs" role="tablist">
			...
			<a class="tabs-tab" role="tab" tabindex="0" aria-controls="ip-search">' . 'Pesquisar por endereço de IP' . '</a>
		</h2>
