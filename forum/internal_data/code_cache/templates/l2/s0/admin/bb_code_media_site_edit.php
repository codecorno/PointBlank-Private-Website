...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__templater->method($__vars['site'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Adicionar BBcode site de mídia');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Editar BBcode site de mídia' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['site']['site_title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'label' => 'Media site ID',
		'explain' => 'Isso será usado para identificar o site de mídia para carregar no BBcode. Não pode ser alterado uma vez definido.',
	)) . '
		...
		'label' => '
					' . 'Mostrar este site na lista de sites \'suportados\' mostrados aos visitantes' . '
				',
		'_type' => 'option',
	)), array(
	)) . '
