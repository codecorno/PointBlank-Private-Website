...
';
	...
	' . $__templater->button('Adicionar widget', array(
				...
				if (!$__templater->test($__vars['groupedWidgets'][$__vars['positionId']], 'empty', array())) {
					...
					if ($__vars['positionId'] == '') {
						$__compilerTemp1 .= '
							...
							'label' => $__vars['xf']['language']['parenthesis_open'] . 'Sem posição' . $__vars['xf']['language']['parenthesis_close'],
					...
					if ($__templater->isTraversable($__vars['groupedWidgets'][$__vars['positionId']])) {
						foreach ($__vars['groupedWidgets'][$__vars['positionId']] AS $__vars['widget']) {
							$__compilerTemp1 .= '
								...
								'tooltip' => ($__vars['positionId'] ? 'Delete from this position' : 'Excluir'),
								'_type' => 'delete',
								'html' => '',
							))) . '
								';
