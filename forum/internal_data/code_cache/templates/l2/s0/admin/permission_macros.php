...
return array('macros' => array('edit_outer' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="block-outer"
		...
		<div class="block-outer-opposite quickFilter">
			<input type="text" class="input js-permissionFilterInput" placeholder="' . $__templater->filter('Filtrar' . $__vars['xf']['language']['ellipsis'], array(array('for_attr', array()),), true) . '" />
		</div>
	</div>
