...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Exportar idioma' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['language']['title']));
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'hint' => 'Isso é útil se você deseja traduzir esse idioma usando o arquivo XML diretamente.',
		'_type' => 'option',
	)), array(
	)) . '
		</div>
