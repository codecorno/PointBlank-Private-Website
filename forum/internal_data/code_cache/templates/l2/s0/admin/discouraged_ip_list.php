		...
		if ($__templater->isTraversable($__vars['discouragedIps'])) {
			foreach ($__vars['discouragedIps'] AS $__vars['discouragedIp']) {
				...
				array(
					'_type' => 'cell',
					'html' => '
								' . ($__vars['discouragedIp']['last_triggered_date'] ? $__templater->func('date_dynamic', array($__vars['discouragedIp']['last_triggered_date'], ), true) : 'Nunca') . '
							',
				),
				array(
					'_type' => 'cell',
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Nenhum IP foi desencorajado.' . '</div>
';
	}
	$__finalCompiled .= '
