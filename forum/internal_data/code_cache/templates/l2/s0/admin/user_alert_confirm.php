	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formRow('
				...
				<a href="' . $__templater->func('link', array('users/list', null, array('criteria' => $__vars['criteria'], ), ), true) . '">' . 'Ver lista completa' . '</a>
			', array(
		'label' => 'Número de usuários que correspondem a critérios',
	)) . '
			' . $__templater->formRow('
				' . $__templater->button('Enviar teste', array(
		'type' => 'submit',
		'name' => 'test',
		'value' => '1',
	), '', array(
