...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Reconstruir caches');
	$__finalCompiled .= '
...
';
	$__compilerTemp1 = array(array(
		'label' => $__vars['xf']['language']['parenthesis_open'] . 'Todos' . $__vars['xf']['language']['parenthesis_close'],
		'_type' => 'option',
	));
...
';
	...
	' . $__templater->formCheckBoxRow(array(
		...
		'hint' => 'Isso diminuirá o processo e só será necessário se as postagens forem mostradas em uma ordem incorreta ou para mostrar aos usuários quando eles tiverem sido postados em um tópico.',
		'_type' => 'option',
	)), array(
	)) . '
');
...
' . $__templater->callMacro(null, 'rebuild_job', array(
		'header' => 'Reconstruir promoções de grupos de usuários',
		'job' => 'XF:UserGroupPromotion',
	), $__vars) . '
' . '

' . $__templater->callMacro(null, 'rebuild_job', array(
		'header' => 'Reconstruir troféus',
		'job' => 'XF:Trophy',
	), $__vars) . '
' . '
...
' . $__templater->callMacro(null, 'rebuild_job', array(
		'header' => 'Reconstruir miniaturas de anexos',
		'job' => 'XF:AttachmentThumb',
	), $__vars) . '
' . '

' . $__templater->callMacro(null, 'rebuild_job', array(
		'header' => 'Reconstruir conversas',
		'job' => 'XF:Conversation',
	), $__vars) . '
' . '
...
');
	$__finalCompiled .= '
' . $__templater->callMacro(null, 'rebuild_job', array(
		'header' => 'Reconstruir estatísticas diárias',
...
' . $__templater->form('
	<div class="block-container">
		<h2 class="block-header">' . 'Limpar permissões' . '</h2>
...
';
	...
	' . $__templater->formInfoRow('O conteúdo do sitemap pode ser controlado através das opções <a href="admin.php?options/groups/sitemap/">geração de sitemap XML</a>.', array(
	)) . '
');
	$__finalCompiled .= '
' . $__templater->callMacro(null, 'rebuild_job', array(
