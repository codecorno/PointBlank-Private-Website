...
';
	...
	' . $__templater->button('Banir usuário', array(
		...
		if ($__templater->isTraversable($__vars['userBans'])) {
			foreach ($__vars['userBans'] AS $__vars['userBan']) {
				...
				array(
					'href' => $__templater->func('link', array('banning/users', $__vars['userBan']['User'], ), false),
					'_type' => 'cell',
					'html' => ($__vars['userBan']['end_date'] ? $__templater->func('date', array($__vars['userBan']['end_date'], ), true) : 'Permanente'),
				),
				array(
					'href' => $__templater->func('link', array('banning/users', $__vars['userBan']['User'], ), false),
					'_type' => 'cell',
