	...
	$__finalCompiled .= '
			<div class="block-outer-opposite quickFilter u-jsOnly"
				...
				<div class="inputGroup inputGroup--inline inputGroup--joined">
					<input type="text" class="input js-filterInput" placeholder="' . $__templater->filter('Filtrar' . $__vars['xf']['language']['ellipsis'], array(array('for_attr', array()),), true) . '" />
...
'addon_list_item_footer' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['addOn']['dev'] OR $__vars['addOn']['dev_url']) {
		...
		if ($__vars['addOn']['dev'] AND $__vars['addOn']['dev_url']) {
			$__finalCompiled .= '
						<span class="addOnList-row-noSearch">' . 'Desenvolvedor' . $__vars['xf']['language']['label_separator'] . '</span> <a href="' . $__templater->escape($__vars['addOn']['dev_url']) . '" target="_blank">' . $__templater->escape($__vars['addOn']['dev']) . '</a>
					';
		} else if ($__vars['addOn']['dev']) {
			$__finalCompiled .= '
						<span class="addOnList-row-noSearch">' . 'Desenvolvedor' . $__vars['xf']['language']['label_separator'] . '</span> ' . $__templater->escape($__vars['addOn']['dev']) . '
					';
		} else if ($__vars['addOn']['dev_url']) {
			$__finalCompiled .= '
						<span class="addOnList-row-noSearch">' . 'Desenvolvedor' . $__vars['xf']['language']['label_separator'] . '</span> <a href="' . $__templater->escape($__vars['addOn']['dev_url']) . '" target="_blank">' . $__templater->escape($__vars['addOn']['dev_url']) . '</a>
					';
		}
		$__finalCompiled .= '
				</li>
	...
	if ($__vars['addOn']['support_url']) {
		$__finalCompiled .= '
				<li><a href="' . $__templater->escape($__vars['addOn']['support_url']) . '" target="_blank">' . 'Suporte' . '</a></li>
			';
	}
	$__finalCompiled .= '
			';
