...
';
	$__templater->breadcrumb($__templater->preEscaped('Permissões' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['record']['title'])), $__templater->func('link', array('nodes/permissions', $__vars['record'], ), false), array(
	));
	$__finalCompiled .= '
