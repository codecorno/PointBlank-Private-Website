...
';
		...
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Edit warning action' . $__vars['xf']['language']['label_separator'] . ' ' . 'Pontos' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['action']['points']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
';
	...
	array(
		'value' => 'groups',
		'label' => 'Adicionar aos grupos selecionados',
