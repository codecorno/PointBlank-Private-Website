...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	array(
		...
		'value' => $__vars['option']['option_value']['frequencyCutOff'],
					...
					<p class="formRow-explain">' . 'Você pode optar por apenas contar hits contra o banco de dados de spam que foram relatados anteriormente um certo número de vezes.' . '</p>
				'),
		'_type' => 'option',
	),
	array(
