...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	<div class="menu-row">
		' . 'Idioma' . $__vars['xf']['language']['label_separator'] . '
	...
	<div class="menu-row menu-row--separated">
		' . 'Complemento' . $__vars['xf']['language']['label_separator'] . '
		<div class="u-inputSpacer">
	...
	<div class="menu-row">
		' . 'Título contém' . $__vars['xf']['language']['label_separator'] . '
		<div class="u-inputSpacer">
	...
	<div class="menu-row menu-row--separated">
		' . 'O texto contém' . $__vars['xf']['language']['label_separator'] . '
		<div class="u-inputSpacer">
			<ul class="inputList">
				<li>
	...
	<div class="menu-row menu-row--separated">
		' . 'Status da frase' . $__vars['xf']['language']['label_separator'] . '
		<div class="u-inputSpacer">
