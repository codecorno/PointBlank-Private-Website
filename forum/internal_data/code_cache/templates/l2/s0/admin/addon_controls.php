...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__vars['hasOptions']) {
		$__compilerTemp2 .= '
					<a href="' . (($__vars['hasOptions'] === true) ? $__templater->func('link', array('add-ons/options', $__vars['addOn'], ), true) : $__templater->func('link', array($__vars['hasOptions'], ), true)) . '" class="menu-linkRow">' . 'Opções' . '</a>
				';
	}
	$__compilerTemp2 .= '
				';
	...
	if ($__vars['hasPhrases']) {
		$__compilerTemp2 .= '
					<a href="' . $__templater->func('link', array('languages/phrases', $__vars['language'], array('addon_id' => $__vars['addOn']['addon_id'], ), ), true) . '" class="menu-linkRow">' . 'Frases' . '</a>
				';
	}
	$__compilerTemp2 .= '
			';
	...
	if (($__templater->method($__vars['addOn'], 'isInstalled', array()) OR $__templater->method($__vars['addOn'], 'canUpgrade', array())) AND (!$__templater->method($__vars['addOn'], 'isLegacy', array()))) {
		$__compilerTemp3 .= '
					<a href="' . $__templater->func('link', array('add-ons/toggle', $__vars['addOn'], array('t' => $__templater->func('csrf_token', array(), false), ), ), true) . '" class="menu-linkRow">' . ($__vars['addOn']['active'] ? 'Desativar' : 'Enable') . '</a>
				';
	}
	$__compilerTemp3 .= '
				';
	...
	if ($__templater->method($__vars['addOn'], 'isFileVersionValid', array()) AND $__templater->method($__vars['addOn'], 'canRebuild', array())) {
		$__compilerTemp3 .= '
					<a href="' . $__templater->func('link', array('add-ons/rebuild', $__vars['addOn'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Reconstruir' . '</a>
				';
	}
	$__compilerTemp3 .= '
				';
