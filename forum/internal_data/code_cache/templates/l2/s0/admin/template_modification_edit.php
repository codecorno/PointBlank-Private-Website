...
' . $__templater->form('
		...
		'label' => 'Descrição',
			...
			<div class="js-templateContentsContainer u-hidden u-hidden--transition">
				' . $__templater->formRow('
					...
					><!--
						--><i>' . 'Não foi possível encontrar o modelo solicitado.' . '</i><!--
					--></pre>
				', array(
		'rowtype' => 'input',
	...
	array(
		...
		'label' => 'Substituir',
		'explain' => 'Você pode usar $0 para inserir o texto encontrado. Para expressões regulares, você pode usar $1 e assim por diante para inserir subconjuntos. Expressões regulares também devem escapar de barras invertidas no conteúdo de substituição (usando \\\\). Você pode usar a sintaxe do modelo XenForo.',
	)) . '
		...
		'html' => '
			' . $__templater->button('Testar', array(
		'type' => 'submit',
		'name' => 'test',
		'value' => '1',
	), '', array(
