...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Pergunta e resposta CAPTCHAs');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Adicionar pergunta', array(
		...
		if ($__templater->isTraversable($__vars['questions'])) {
			foreach ($__vars['questions'] AS $__vars['question']) {
				...
				array(
					...
					'submit' => 'true',
					'tooltip' => 'Ativar / desativar \'' . $__vars['question']['question'] . '\'',
					'_type' => 'toggle',
					'html' => '',
				),
				array(
