...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__templater->method($__vars['prefixGroup'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Adicionar grupo de prefixos');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Editar grupo de prefixo' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['prefixGroup']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
