	...
	<div class="block-container">
		<div class="block-body block-row">
			...
			<ul class="listInline listInline--bullet u-muted">
				<li>' . 'Gerado por' . $__vars['xf']['language']['label_separator'] . ' ' . ($__vars['entry']['User'] ? (((('<a href="' . $__templater->func('link', array('users/edit', $__vars['entry'], ), true)) . '">') . $__templater->escape($__vars['entry']['User']['username'])) . '</a>') : 'Unknown account') . '</li>
