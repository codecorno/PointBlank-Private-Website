...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Exportar estilo' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['style']['title']));
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'hint' => 'Se selecionado, as personalizações nos estilos pai serão incluídas como se fossem feitas neste estilo.',
		'_type' => 'option',
	)), array(
	)) . '
		</div>
...
', array(
		'action' => $__templater->func('link', array('styles/export', $__vars['style'], ), false),
		'class' => 'block',
	));
