...
return array('macros' => array('user_tabs' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__vars['tabs'] = $__templater->preEscaped('
		...
		<a class="tabs-tab' . (($__vars['active'] == 'user_field') ? ' is-active' : '') . '"
			...
			' . 'Critérios de campo do usuário' . '</a>
	');
	$__finalCompiled .= '
	';
	if ($__vars['container']) {
...
'user_panes' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__compilerTemp6 = array(array(
		...
		'label' => 'O usuário está navegando com o seguinte idioma' . $__vars['xf']['language']['label_separator'],
	...
	$__compilerTemp6[] = array(
		'label' => 'Verificação em duas etapas' . $__vars['xf']['language']['label_separator'],
		'_type' => 'optgroup',
		'options' => array(),
	);
	...
	$__compilerTemp6[$__compilerTemp9]['options'][] = array(
		...
		'label' => 'O usuário ativou a verificação em duas etapas',
		'_type' => 'option',
	);
	$__compilerTemp6[$__compilerTemp9]['options'][] = array(
		...
		'label' => 'O usuário não ativou a verificação em duas etapas',
		'_type' => 'option',
	);
	$__compilerTemp10 = '';
	$__compilerTemp11 = '';
			...
			if ($__templater->isTraversable($__vars['customFields'])) {
				foreach ($__vars['customFields'] AS $__vars['fieldId'] => $__vars['fieldDefinition']) {
					...
					$__compilerTemp13 .= $__templater->formCheckBoxRow(array(
						...
						'label' => ($__vars['choices'] ? 'User choice is among' : 'O valor do usuário contém texto' . $__vars['xf']['language']['label_separator']),
						'_dependent' => array('
												' . $__compilerTemp14 . '
											'),
						'_type' => 'option',
	...
	array(
		...
		'label' => 'O aniversário do usuário é hoje',
		'_type' => 'option',
	),
	array(
		...
		'label' => 'O estado do usuário é' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array('
	...
	array(
		...
		'label' => 'O usuário está associado a qualquer um dos provedores de contas conectados selecionados' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formSelect(array(
		...
		'label' => 'O usuário é membro de qualquer um dos grupos de usuários selecionados' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formSelect(array(
	...
	array(
		...
		'label' => 'O usuário NÃO é membro de nenhum dos grupos de usuários selecionados' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formSelect(array(
		...
		'label' => 'O usuário postou pelo menos X mensagens' . $__vars['xf']['language']['label_separator'],
	...
	array(
		...
		'label' => 'O usuário postou mais de X mensagens' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
	...
	array(
		...
		'label' => 'O usuário tem pelo menos X pontos de troféu' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
	...
	array(
		...
		'label' => 'O nome de usuário é' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formTextBox(array(
		'name' => 'user_criteria[username][data][names]',
		'value' => $__vars['criteria']['username']['names'],
		'ac' => 'true',
	))),
		'afterhint' => 'Se você quiser fazer a correspondência de usuários específicos, digite seu nome de usuário aqui, separados por vírgulas.',
		'_type' => 'option',
	),
	array(
		...
		'label' => 'O nome de usuário contém' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formTextBox(array(
		'name' => 'user_criteria[username_search][data][needles]',
		'value' => $__vars['criteria']['username_search']['needles'],
	))),
		'afterhint' => 'Você pode inserir um ou mais trechos de texto separados por vírgulas e os usuários cujos nomes contenham qualquer um dos snippets corresponderão aos critérios.',
		'_type' => 'option',
	),
	array(
		...
		'label' => 'O endereço de e-mail do usuário contém' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formTextBox(array(
		'name' => 'user_criteria[email_search][data][needles]',
		'value' => $__vars['criteria']['email_search']['needles'],
	))),
		'afterhint' => 'Você pode inserir um ou mais trechos de texto separados por vírgulas e os usuários cujos endereços de e-mail contêm algum dos snippets corresponderão aos critérios.',
		'_type' => 'option',
	)), array(
...
'page_panes' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__vars['panes'] = $__templater->preEscaped('
		...
		'class' => 'input--inline input--autoSize',
						...
						<dfn class="inputChoices-explain inputChoices-explain--after">' . 'Você pode deixar a data vazia para que esses critérios coincidam ao mesmo tempo todos os dias.' . '</dfn>
	...
	array(
		...
		'class' => 'input--inline input--autoSize',
						...
						<dfn class="inputChoices-explain inputChoices-explain--before">' . 'Você pode deixar a data vazia para que esses critérios coincidam ao mesmo tempo todos os dias.' . '</dfn>
					', $__templater->formRadio(array(
