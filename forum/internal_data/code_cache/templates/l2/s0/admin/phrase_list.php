		...
		';
			...
			if ($__vars['phrase']['language_id'] == $__vars['language']['language_id']) {
				$__compilerTemp1[] = array(
					...
					'tooltip' => ($__vars['phrase']['language_id'] ? 'Reverter' : 'Excluir'),
					'_type' => 'delete',
					'html' => '',
				);
			}
...
'search_menu' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="block-filterBar">
		<div class="filterBar">
			<a class="filterBar-menuTrigger" data-xf-click="menu" role="button" tabindex="0" aria-expanded="false" aria-haspopup="true">' . 'Refinar e traduzir' . '</a>
			<div class="menu menu--wide" data-menu="menu" aria-hidden="true"
				...
				<div class="menu-content">
					<h4 class="menu-header">' . 'Refinar e traduzir' . '</h4>
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped($__templater->escape($__vars['language']['title']) . ' - ' . 'Frases');
	$__finalCompiled .= '
