...
';
	...
	' . $__templater->button('Adicionar tag', array(
...
';
	...
	<div class="block-outer">
		...
		'class' => 'input--inline filterBlock-input',
			...
			<span>
				<span class="filterBlock-label">' . 'Ordenado por' . $__vars['xf']['language']['label_separator'] . '</span>
