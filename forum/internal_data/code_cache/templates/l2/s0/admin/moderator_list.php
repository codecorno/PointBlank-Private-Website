...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Moderadores');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Adicionar moderador', array(
...
';
	...
	';
		...
		<div class="block">
			<div class="block-container">
				<h2 class="block-header">' . 'Super moderadores' . '</h2>
	...
	';
		...
		<div class="block">
			<div class="block-container">
				<h2 class="block-header">' . 'Moderadores de conteúdo' . '</h2>
				<div class="block-body">
					';
			$__compilerTemp2 = '';
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Não existem atualmente moderadores. Use o link acima para criar um.' . '</div>
';
	}
