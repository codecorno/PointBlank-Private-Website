...
';
	...
	if ($__vars['errors']) {
		$__compilerTemp1 .= '
					' . 'Encontramos alguns erros ao tentar atualizar o seguinte complemento' . $__vars['xf']['language']['label_separator'] . '
				';
	} else if ($__vars['warnings']) {
		$__compilerTemp1 .= '
					' . 'Revise os avisos e confirme que deseja continuar atualizando o seguinte complemento' . $__vars['xf']['language']['label_separator'] . '
				';
	} else {
		$__compilerTemp1 .= '
					' . 'Confirme que deseja atualizar o seguinte complemento' . $__vars['xf']['language']['label_separator'] . '
				';
	}
