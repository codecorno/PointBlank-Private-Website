...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Páginas de ajuda');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Adicionar página de ajuda', array(
		...
		if ($__templater->isTraversable($__vars['pages'])) {
			foreach ($__vars['pages'] AS $__vars['page']) {
				$__compilerTemp1 .= '
					...
					'submit' => 'true',
					'tooltip' => 'Ativar / desativar \'' . $__vars['page']['title'] . '\'',
					'_type' => 'toggle',
					'html' => '',
				))) . '
					';
