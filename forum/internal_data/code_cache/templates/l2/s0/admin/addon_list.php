...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Complementos');
	$__finalCompiled .= '
...
';
	...
	<div class="addOnList">
		...
		' . $__templater->callMacro('addon_list_macros', 'addon_list_block', array(
			...
			'heading' => 'Complementos instaláveis',
		), $__vars) . '
		' . '
		' . $__templater->callMacro('addon_list_macros', 'addon_list_block', array(
			'addOns' => $__vars['installed'],
			'heading' => 'Complementos instalados',
		), $__vars) . '
		' . '
		' . $__templater->callMacro('addon_list_macros', 'addon_list_block', array(
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Nenhum complemento está instalado ou disponível para ser instalado.' . '</div>
';
	}
