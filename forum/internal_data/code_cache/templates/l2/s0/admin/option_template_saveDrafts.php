	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'_dependent' => array('
			<dl class="inputLabelPair">
				<dt><label for="' . $__templater->escape($__vars['inputName']) . '_h">' . 'Salvar rascunhos a cada X horas' . '</label></dt>
		...
		'min' => '1',
			...
			<dl class="inputLabelPair">
				<dt><label for="' . $__templater->escape($__vars['inputName']) . '_s">' . 'Salvar rascunhos a cada X segundos' . '</label></dt>
				<dd>' . $__templater->formNumberBox(array(
