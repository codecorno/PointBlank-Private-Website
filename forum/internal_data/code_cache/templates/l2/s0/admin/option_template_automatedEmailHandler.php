...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'data-hide' => 'true',
		'_dependent' => array('
			<div class="inputChoices-spacer">' . 'Tipo de conexão' . '</div>
	...
	array(
		...
		'size' => '5',
			...
			<div class="inputChoices-spacer">' . 'Nome de usuário e senha' . '</div>
			<div class="inputGroup">
				' . $__templater->formTextBox(array(
		...
		'size' => '15',
			...
			<div class="inputChoices-spacer">' . 'Criptografia' . '</div>
			' . $__templater->formRadio(array(
