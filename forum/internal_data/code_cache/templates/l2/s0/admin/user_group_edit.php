...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__templater->method($__vars['userGroup'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Adicionar grupo de usuário');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Editar grupo de usuário' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['userGroup']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
';
	...
	$__compilerTemp1[] = array(
		...
		'label' => 'Outro, usando o nome de classe CSS personalizado',
	...
	<div class="block-container">
		...
		'label' => 'Mostrar prioridade de estilo',
		'explain' => 'Se um usuário estiver em vários grupos de usuários, seu nome de usuário e nome de usuário CSS virá do grupo com a prioridade de estilo de exibição mais alta.',
	)) . '
	...
	array(
		...
		'explain' => 'Isso será exibido sob o nome de membros deste grupo em determinadas circunstâncias, como com posts.',
	)) . '
