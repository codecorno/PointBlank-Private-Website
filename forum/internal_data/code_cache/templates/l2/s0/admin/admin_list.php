...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Administradores');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Adicionar administrador', array(
			...
			array(
				...
				'hint' => '
								<ul class="listInline listInline--bullet listInline--selfInline">
									<li>' . 'Último login' . $__vars['xf']['language']['label_separator'] . ' ' . ($__vars['admin']['last_login'] ? $__templater->func('date_dynamic', array($__vars['admin']['last_login'], ), true) : 'N/A') . '</li>
									' . $__compilerTemp2 . '
								</ul>
							',
				'_type' => 'main',
