...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Importar uma linguagem');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'label' => 'Importar do arquivo XML carregado',
	)) . '
		...
		'value' => 'new',
		'checked' => 'checked',
		'label' => 'Filho do idioma' . $__vars['xf']['language']['label_separator'],
