...
';
	...
	';
		...
		$__finalCompiled .= $__templater->formSelectRow(array(
			...
			'label' => 'Grupo principal de usuários',
		)) . '
';
	} else {
		$__finalCompiled .= '
...
';
	...
	$__finalCompiled .= $__templater->formRadioRow(array(
		...
		'value' => '1',
		'label' => 'Membro de nenhum grupo secundário',
		'_type' => 'option',
	),
	array(
		'value' => '0',
		'label' => 'Membro de qualquer um desses grupos secundários',
...
';
	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'label' => 'Não em grupos secundários',
	)) . '
