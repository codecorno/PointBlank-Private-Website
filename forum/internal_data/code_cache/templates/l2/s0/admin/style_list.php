...
'style_list_entry' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['style']['style_id']) {
		$__compilerTemp2[] = array(
			...
			'submit' => 'true',
			'tooltip' => 'Ativar / desativar \'' . $__vars['style']['title'] . '\'',
			'_type' => 'toggle',
			'html' => '',
		);
		$__compilerTemp2[] = array(
			...
			'html' => '
				<div class="menu" data-menu="menu" aria-hidden="true" data-menu-builder="dataList">
					<div class="menu-content">
						<h3 class="menu-header">' . 'Mais opções' . '</h3>
						<a href="' . $__templater->func('link', array('styles/export', $__vars['style'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Exportar' . '</a>
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Estilos');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Adicionar estilo', array(
