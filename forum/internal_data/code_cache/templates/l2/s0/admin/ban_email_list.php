		...
		if ($__templater->isTraversable($__vars['emailBans'])) {
			foreach ($__vars['emailBans'] AS $__vars['emailBan']) {
				...
				array(
					'_type' => 'cell',
					'html' => '
								' . ($__vars['emailBan']['last_triggered_date'] ? $__templater->func('date_dynamic', array($__vars['emailBan']['last_triggered_date'], ), true) : 'Nunca') . '
							',
				),
				array(
					'_type' => 'cell',
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Nenhum endereço de e-mail foi banido.' . '</div>
';
	}
	$__finalCompiled .= '
