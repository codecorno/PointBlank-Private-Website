...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Editar moderador' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['user']['username']));
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'rowid' => 'addUserGroups',
		'label' => 'Adicionar moderador aos grupos de usuários',
		'hint' => '
					' . $__templater->formCheckBox(array(
		'standalone' => 'true',
	), array(array(
