...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Navegador de anexos');
	$__finalCompiled .= '

';
	$__compilerTemp1 = array(array(
		'label' => $__vars['xf']['language']['parenthesis_open'] . 'Todos os tipos de conteúdo' . $__vars['xf']['language']['parenthesis_close'],
		'_type' => 'option',
	));
	...
	$__compilerTemp2 = array(array(
		'label' => 'Predefinições de data' . $__vars['xf']['language']['label_separator'],
		'value' => '-1',
		'_type' => 'option',
	));
