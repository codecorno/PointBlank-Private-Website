...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Permissões');
	$__finalCompiled .= '
	...
	<div class="block">
		<div class="block-container">
			<h2 class="block-header">
				...
				<a href="' . $__templater->func('link', array('permission-definitions/interface-groups/edit', $__vars['interfaceGroup'], ), true) . '" class="u-pullRight">' . 'Editar' . '</a>
