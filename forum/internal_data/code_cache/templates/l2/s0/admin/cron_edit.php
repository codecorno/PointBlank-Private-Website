...
' . $__templater->form('
	...
	<div class="block-container">
		...
		'value' => 'dom',
		'label' => 'Dia do mês' . $__vars['xf']['language']['label_separator'],
	...
	array(
		'value' => 'dow',
		'label' => 'Dia da semana' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formSelect(array(
		'name' => 'run_rules[dow]',
		'readonly' => (!$__templater->method($__vars['entry'], 'canEdit', array())),
	...
	array(
		'value' => '12',
		'label' => '12 ' . $__vars['xf']['language']['parenthesis_open'] . 'Meio-dia' . $__vars['xf']['language']['parenthesis_close'],
		'_type' => 'option',
	),
	array(
		'value' => '13',
