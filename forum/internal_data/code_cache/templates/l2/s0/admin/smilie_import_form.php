		...
		$__finalCompiled .= '
			<h3 class="block-formSectionHeader">
				<span class="collapseTrigger collapseTrigger--block" data-xf-click="toggle" data-target=".js-importSmilie' . $__templater->escape($__vars['i']) . 'Advanced">
					<span class="block-formSectionHeader-aligner">' . 'Mais opções' . '</span>
				</span>
			</h3>
		';
	}
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Importar smilies');
	$__finalCompiled .= '
