...
';
	...
	<div class="block-container">
		...
		'label' => 'Todos os usuários válidos',
		'_type' => 'option',
	),
	array(
		'value' => 'searcher',
		'selected' => $__vars['memberStat']['criteria'],
		'label' => 'Critérios de pesquisa',
...
<code>return [$user->user_id => \\XF::language()->numberFormat($value)];</code>',
		...
		'readonly' => (!$__templater->method($__vars['memberStat'], 'canEdit', array())),
		'label' => 'Mostrar valor',
		'hint' => 'Se ativado e fornecido, um valor será exibido para cada usuário.',
		'_type' => 'option',
	),
	array(
		'name' => 'overview_display',
		'selected' => $__vars['memberStat']['overview_display'],
		'label' => 'Mostrar na guia de visão geral',
		'hint' => (('Se ativado, os top 5 membros desta estatística serão exibidos na guia de visão geral.' . ' ') . (($__vars['xf']['development'] AND $__vars['memberStat']['addon_id']) ? 'The value of this field will not be changed when this add-on is upgraded.' : '')),
		'_type' => 'option',
	)), array(
		'label' => 'Opções',
	)) . '
		...
		'label' => 'Ativar cache e cache por X minutos' . $__vars['xf']['language']['label_separator'],
		...
		'hint' => (('Use isso para desativar o status do membro exibido na página Membros.' . ' ') . (($__vars['xf']['development'] AND $__vars['memberStat']['addon_id']) ? 'The value of this field will not be changed when this add-on is upgraded.' : '')),
		'_type' => 'option',
	)), array(
	)) . '
