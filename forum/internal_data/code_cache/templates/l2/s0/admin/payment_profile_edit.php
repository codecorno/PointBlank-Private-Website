...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__templater->method($__vars['profile'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Adicionar perfil de pagamento' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['provider']['title']));
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Editar perfil de pagamento' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['provider']['title']) . ' - ' . $__templater->escape($__vars['profile']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
' . $__templater->form('
	<div class="block-container">
		...
		'explain' => 'Insira um nome para este perfil de pagamento a ser mostrado aos usuários ao comprar produtos com esse perfil. Se nenhum título de exibição for inserido, o título do perfil acima será usado em vez disso.',
	)) . '
