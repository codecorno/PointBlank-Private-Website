...
';
	...
	<div class="block-container">
		...
		'label' => 'Aplicar opções de estilo de exibição' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array('
		...
		'label' => 'Aplicar opções de grupo de prefixos' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array('
		...
		'label' => 'Aplicar opções de grupo de usuários' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array('
		...
		'label' => 'Usável por grupos de usuários',
	)) . '
