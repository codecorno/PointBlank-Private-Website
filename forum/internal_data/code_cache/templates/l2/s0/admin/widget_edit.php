...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__templater->method($__vars['widget'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Adicionar widget');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Editar widget' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['widget']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'label' => 'Título',
		'hint' => 'Opcional',
		'explain' => 'Você pode optar por inserir um título específico para este widget. Se você não digitar um, o widget exibirá um título apropriado. Observe que nem todos os widgets exibirão um título específico.',
	)) . '
