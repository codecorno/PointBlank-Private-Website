...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Alertar usuários');
	$__finalCompiled .= '
';
...
';
	...
	<div class="blockMessage blockMessage--success blockMessage--iconic">
		' . 'Seu alerta foi enviado para ' . $__templater->filter($__vars['sent'], array(array('number', array()),), true) . ' usuários.' . '
	</div>
';
	}
	$__finalCompiled .= '
