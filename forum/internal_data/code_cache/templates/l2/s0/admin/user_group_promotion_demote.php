		...
		$__compilerTemp1 .= '
			<div class="block-body">
				' . $__templater->formInfoRow('
					' . 'Confirme que deseja remover este usuário da promoção selecionada' . $__vars['xf']['language']['label_separator'] . '
					<strong>' . $__templater->escape($__vars['user']['username']) . ' - ' . $__templater->escape($__vars['promotion']['title']) . '</strong>
					' . 'Este usuário não receberá esta promoção, mesmo se ele ou ela atende aos requisitos.' . '
				', array(
			'rowtype' => 'confirm',
		)) . '
			</div>
