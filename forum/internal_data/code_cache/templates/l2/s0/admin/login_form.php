...
';
	...
	<dl class="adminLogin-row">
		<dt>' . 'Seu nome ou endereço de e-mail' . $__vars['xf']['language']['label_separator'] . '</dt>
		<dd>
			' . $__templater->formTextBox(array(
		'name' => 'login',
		'value' => $__vars['xf']['visitor']['username'],
		'placeholder' => 'Nome de usuário ou e-mail' . $__vars['xf']['language']['ellipsis'],
	...
	<dl class="adminLogin-row">
		<dt>' . 'Senha' . $__vars['xf']['language']['label_separator'] . '</dt>
		<dd>
			' . '' . '
			' . $__templater->formPasswordBox(array(
		'name' => 'password',
		'placeholder' => 'Senha' . $__vars['xf']['language']['ellipsis'],
		'aria-label' => 'Senha',
