...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Atualizar tópicos por lote');
	$__finalCompiled .= '
...
';
	...
	if ($__vars['prefixes']['prefixesGrouped']) {
		$__compilerTemp4 .= '
			...
			'explain' => 'O prefixo só será aplicado se for válido para o fórum em que o tópico está ou está sendo movido.',
		)) . '
			';
	}
	$__compilerTemp5 = '';
	...
	<div class="block-container">
		<h2 class="block-header">' . 'Atualizar tópicos' . '</h2>
	...
	array(
		'name' => 'actions[lock]',
		'value' => 'lock',
		'label' => 'Bloquear tópicos',
		'_type' => 'option',
	),
	array(
		'name' => 'actions[unlock]',
		'value' => 'unlock',
		'label' => 'Desbloquear tópicos',
		'_type' => 'option',
	),
	array(
		'name' => 'actions[approve]',
		'value' => 'approve',
		'label' => 'Aprovar tópicos',
		'_type' => 'option',
	),
	array(
		'name' => 'actions[unapprove]',
		'value' => 'unapprove',
		'label' => 'Desaprovar tópicos',
		'_type' => 'option',
	),
	array(
...
';
	...
	$__finalCompiled .= $__templater->form('
	<div class="block-container">
		<h2 class="block-header">' . 'Excluir tópicos' . '</h2>
		<div class="block-body">
			' . $__templater->formCheckBoxRow(array(
	), array(array(
		'name' => 'actions[delete]',
		'label' => '
					' . 'Confirmar exclusão de ' . $__templater->filter($__vars['total'], array(array('number', array()),), true) . ' tópicos' . '
				',
		'_type' => 'option',
	)), array(
	)) . '
