...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__templater->method($__vars['ad'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Adicionar anúncio');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Editar anúncio' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['ad']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'label' => 'Título',
		'explain' => 'Forneça um título curto para este anúncio, que aparecerá na página da lista de anúncios.',
	)) . '
	...
	array(
		...
		'label' => 'A publicidade está ativa',
		'_type' => 'option',
	)), array(
	)) . '
		</div>
